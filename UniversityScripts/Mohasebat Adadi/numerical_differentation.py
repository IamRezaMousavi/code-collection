...
if __name__=="__main__":
    ...
    def f(x):
        if x == 1: return 0
        elif x == 2: return 1.3863
        elif x == 3: return 3.2958
    
    def x(t):
        if t == 0: return 0
        elif t == 0.5: return 3.65
        elif t == 1: return 6.8
        elif t == 1.5: return 9.9
        elif t == 2: return 12.15
    
    def xln(x):
        x = round(x, 2)
        if x == 1.2: return 0.2188
        elif x == 1.4: return 0.4711
        elif x == 1.6: return 0.7520
        elif x == 1.8: return 1.0580
        elif x == 2: return 1.3863
