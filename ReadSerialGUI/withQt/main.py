...
from PyQt5.QtWidgets import (QApplication, QMainWindow, QGroupBox, QGridLayout,
                             QComboBox, QPushButton, QLabel, QDesktopWidget, QLineEdit)
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        startStorage.setStyleSheet("""QPushButton
                                 {
                                     background: transparent;
                                     color: white;
                                     border: 1px solid;
        ...
        stopStorage.setStyleSheet("""QPushButton
                                 {
                                     background: transparent;
                                     color: white;
                                     border: 1px solid;
        ...
        self.fileNameShow.setStyleSheet("""QLabel
                                    {
                                        color: white;
                                    }
                                    """)
